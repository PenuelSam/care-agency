    ...
    <div className="w-full bgc2 p-[40px]">
        <div className='flex flex-col  justify-between items-center'>
          ...
          <div className='flex gap-5'>
            <LocationOnOutlinedIcon sx={{fontSize: "40px", color: "#fff"}}/>
            <div>
              <h1 className='text-[30px] sm:text-[30px] lg:text-[40px] font-bold text-white'>Address</h1>
              <p className='text-[20px] sm:text-[20px] lg:text-[30px] text-white font-bold w-52'>Canalside House Office 1 383 Ladbroke Grove, London W10 5AA</p>
            </div>
        </div>
        <div className='flex gap-5'>
